...
{{--                                    <a href="{{ route('art.trash') }}" class="btn btn-danger mx-1">سطل زباله <i class="icon-trash"></i></a>--}}
{{--                                </div>--}}
                            </div>
                                        ...
                                        <table class="table table-bordered mt-3">
                                            ...
                                            @forelse($arts as $key => $value)
                                                <tr>
                                                    ...
                                                    <td>{{ $value->artName }}</td>
                                                    <td>
                                                        <a href="{{ route('art.edit' ,  $value->id ) }}" class="btn btn-info mx-1">ویرایش</a>
