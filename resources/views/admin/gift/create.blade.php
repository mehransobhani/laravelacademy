                                    ...
                                    <form method="post" action="{{ route('gift.store') }}">
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-4 col-xl-3 col-md-6">
                                                ...
                                                <input type="text" class="form-control direction-ltr" name="code" id="code" placeholder="کد تخفیف" value="{{ old('code') ?? null}}">
                                            </div>
                                            <div class="form-group mb-4 col-xl-3 col-md-6">
                                                <label for="off">مبلغ تخفیف<span class="required">&nbsp*&nbsp</span></label>
                                                <input type="text" class="form-control IRANSans direction-ltr" name="off" id="off" value="{{ old('off') ?? 0}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group mb-4 col-xl-3 col-md-6">
                                                <label for="percent">درصد تخفیف<span class="required">&nbsp*&nbsp</span></label>
                                                <input type="text" class="form-control IRANSans direction-ltr" name="percent" id="percent" value="{{ old('percent') ?? 0}}">
                                            </div>
                                            <div class="form-group mb-4 col-xl-3 col-md-6">
                                                <label for="maximum">حداکثر مبلغ تخفیف</label>
                                                <input type="text" class="form-control IRANSans direction-ltr" name="maximum" id="maximum" value="{{ old('maximum') ?? 0}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group mb-4 col-xl-3 col-md-6">
                                            ...
                                            <div class="form-group mb-4 col-xl-3 col-md-6">
                                                ...
                                                <input name="end_time" id="end_time" type="text" class="form-control" value="{{ old('end_time')}}" />
                                                <input type="checkbox" class="form-check-input" name="infinity" id="infinity" {{ old('infinity') ? 'checked' : null }} />
                                            ...
                                            <div class="form-group mb-4 col-lg-6">
                                                ...
                                                <select multiple class="form-control" id="courses" name="courses[]">
                                                    @foreach($courses as $key=>$value)
                                                        <option value="{{$value->id}}" {{ is_array(old('courses')) ? in_array( $value->id , old('courses') ) ? 'selected' : null : null }} >{{$value->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-4 col-12">
                                                <input type="checkbox" class="form-check-input" id="reusable" name="reusable" {{ old('reusable') ? 'checked' : null }}>
